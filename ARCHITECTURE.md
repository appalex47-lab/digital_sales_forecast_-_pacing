...
Versión de la app: 0.4.0 (Fase 3). Versión del contrato de datos: **1.3.0**.
...
- Correr la app y confirmar **"73 de 73 pruebas correctas"** (o el total vigente) antes y
  después de cada cambio. Fase 0 aportó 24; Fase 1, 19; Fase 2, 16; Fase 3, 14. Las pruebas se agregan; nunca se borran ni se relajan.
