...
conceptual completo, no el estado real de los datos; su primer paso ahora incluye una nota aclarando que el
siguiente paso *real* está en Inicio, para no confundir las dos cosas.
