...
Versión de la app: 0.8.0 (Fase 7). Versión del contrato de datos: **1.6.0** (Fase 7 no cambia contratos).
...
/js/
  ...
  storage/idb.js                Envoltura mínima de IndexedDB (Fase 8; aún no conectada a la app)
