...
(function (root) {
  ...
  function render(state, status) {
    ...
    const flow = [
      ['Planear', 'plan', status.plan.original || status.plan.imported, 'Meta y plan distribuido'],
      ['Monitorear', 'pacing', status.forecast.available, 'Pacing y forecast'],
      ['Diagnosticar', 'diagnostico', status.visited.diagnostico, 'Drivers, señales, hipótesis'],
  ...
  FP.homeView = { render, periodFigures };
