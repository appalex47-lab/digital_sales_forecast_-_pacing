  ...
  function render(state) {
    ...
    bar.innerHTML = `
      <div class="tour-bar__inner" role="region" aria-label="Recorrido guiado">
        ...
        ${i === 0 ? '<p class="tour-bar__note">Este recorrido enseña el orden completo de la metodología, siempre desde Meta. Tu siguiente paso real, según tus propios datos, está en Inicio.</p>' : ''}
